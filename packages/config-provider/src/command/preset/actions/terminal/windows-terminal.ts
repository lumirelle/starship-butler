...
export function windowsTerminal(): Action {
  return {
    ...
    posthandler: () => {
      consola.info('This configuration will use `"Monaspace Xenon", "Maple Mono CN", "Symbols Nerd Font"` as terminal fonts, "Nushell" as default shell and "Starship" as shell prompt. Don\'t forget to install them, or just exclude this preset if you want to use your own configuration!')
    },
  }
}
